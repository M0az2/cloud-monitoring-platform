...
1. Docker Compose - Simplicity and portability
2. SQLite (Grafana) - No external DB dependency
3. Volume Mounts - Data persistence across restarts
4. Root User Access - Node Exporter needs access to /proc and /sys


## Author

Moaz - DevOps Engineer  
Cloud Infrastructure & Monitoring Specialist
